...
mu = 0.0 # 1.25e-8 / l_unit()**(-1) # Linear drag, 1.25e-8m^-1
nu = 0.0 # 352 / l_unit()**2 / t_unit()**(-1) # Viscosity coefficient, 22m^2s^-1 for the simulation (2048^2)
nv=0.0 #1     # Hyperviscous order (nv=1 is viscosity)
